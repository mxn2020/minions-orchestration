...
/**
 * @minions-orchestration/cli — CLI for Minions Orchestration
 *
...
import { customTypes } from '@minions-orchestration/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Orchestration'));
        console.log(chalk.dim('Clawspace registry, toolbox-to-agent mappings, and fleet configuration'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-orchestration/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-orchestration/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-orchestration')}`);
