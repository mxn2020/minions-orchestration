# Manual Setup Steps for Minions Orchestration
...
Go to **GitHub → mxn2020/minions-orchestration → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-orchestration` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-orchestration-web`
- **GitHub repo**: `mxn2020/minions-orchestration`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `orchestration.minions.wtf`

### Documentation
- **Netlify site name**: `minions-orchestration-docs`
- **GitHub repo**: `mxn2020/minions-orchestration`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `orchestration.minions.help`

### Blog
- **Netlify site name**: `minions-orchestration-blog`
- **GitHub repo**: `mxn2020/minions-orchestration`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `orchestration.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `orchestration.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `orchestration.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `orchestration.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-orchestration/sdk`](https://www.npmjs.com/package/@minions-orchestration/sdk)
- CLI: [`@minions-orchestration/cli`](https://www.npmjs.com/package/@minions-orchestration/cli)
...
Your package: [`minions-orchestration`](https://pypi.org/project/minions-orchestration/)
...
| Item | Value |
|------|-------|
| Project | `minions-orchestration` |
| SDK (npm) | `@minions-orchestration/sdk` |
| CLI (npm) | `@minions-orchestration/cli` |
| Python (PyPI) | `minions-orchestration` |
| GitHub | `github.com/mxn2020/minions-orchestration` |
| Docs domain | `orchestration.minions.help` |
| Blog domain | `orchestration.minions.blog` |
| App domain | `orchestration.minions.wtf` |
